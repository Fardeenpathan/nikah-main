...
export default function CoupleMessage() {
    ...
    return (
        ...
        <div className="bg-[url('/assets/bg_second.webp')] bg-cover bg-no-repeat">
             <div className="lg:h-984 md:h-520 h-754">
                ...
                <h2 className="lg:text-[30px] text-lg  text-center text-[#FFF5B9] lg:px-100 px-6 lg:mt-36 mt-12 jacques-francois lg:leading-8 md:leading-8 leading-7">
          ...
          <div className="flex justify-center mt-20 pb-24">
            ...
            <div className="hidden md:block md:flex items-center lg:mt-60 gap-0">
              ...
              alt="couple"
              className="w-70 h-90 md:w-100 md:h-128 lg:w-270 lg:h-309 object-cover "
            />
            <div className=" lg:ml-0">
            <h2 className="font-cormorant-upright text-xs md:text-4xl lg:text-5xl text-[#FFF5B9] lg:pt-63 jacques-francois-upright pt-4 md:leading-12 leading-3">
            ...
            <div className="flex flex-col-1 md:gap-4 gap-0 lg:gap-0 justify-center items-center md:not-first:mt-4">
              ...
              <h2 className="font-cormorant-upright md:text-2xl lg:text-xl text-[6px] text-[#FFF5B9]  jacques-francois-upright pr-4 lg:pr-40">
