...
export default function CoupleMessage() {
    ...
    const testimonial = [
        {
            img: '/assets/first.webp',
        },

        {
            img: '/assets/second.webp',
        },

         {
            img: '/assets/third.webp',
        },

        {
            img: '/assets/fourth.webp',
        },

         {
            img: '/assets/fifth.webp',
        },  
    ]
    ...
    return (
        ...
        <div className="bg-[url('/assets/bg_second.webp')] bg-cover bg-no-repeat">
             <div className="lg:h-768 md:h-520 h-737">
                <h1 className="lg:text-[50px] md:text-3xl text-[52px] text-center text-[#FFF5B9] lg:pt-32 pt-12 jacques-francois">A message from the couple</h1>
                <h2 className="lg:text-[30px] text-[22px]  text-center text-[#FFF5B9] lg:px-60 px-6 lg:mt-28 mt-12 jacques-francois lg:leading-8 md:leading-8 leading-7">
          ...
          <div className="flex justify-center mt-20 pb-24">
            ...
            <h2 className="font-cormorant-upright lg:text-5xl text-[22px] text-center text-[#FFF5B9] lg:pt-63 jacques-francois-upright pt-4 md:leading-12 leading-6">
            ...
            <div className="flex flex-col-1 md:gap-4 gap-2 justify-center items-center md:not-first:mt-4 ">
              <a href="#" target="_blank">
                <img src="/assets/whatsapp.webp" alt="" className="lg:h-10 lg:w-10 h-6 w-6" />
              </a>
              <h2 className="font-cormorant-upright lg:text-3xl text-[18px] text-center text-[#FFF5B9]  jacques-francois-upright">
